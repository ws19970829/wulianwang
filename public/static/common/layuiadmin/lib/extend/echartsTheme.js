...
;layui.define(function (e) {
    e("echartsTheme", {
        color: ["#3aa0ff", "#36cbcb", "#4ecb73", "#fad337", "#f2637b","#975fe4"],
        title: {textStyle: {fontWeight: "normal", color: "#666"}},
        dataRange: {itemWidth: 15, color: ["#087be6","#b4d6f5"]},
        ...
        categoryAxis: {
            axisLine: {lineStyle: {color: "#3aa0ff"}},
            axisTick: {show: !1},
        ...
        timeline: {
            lineStyle: {color: "#3aa0ff"},
            controlStyle: {normal: {color: "#3aa0ff"}, emphasis: {color: "#3aa0ff"}},
            symbol: "emptyCircle",
            symbolSize: 3
        },
        ...
        map: {
            itemStyle: {
                normal: {areaStyle: {color: "#3aa0ff"}, label: {textStyle: {color: "#555"}}},
                emphasis: {areaStyle: {color: "#36cbcb"}}
            }
        },
