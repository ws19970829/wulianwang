            ...
            $swal: function (type, param, code) {
                ...
                switch (type) {
                    ...
                    case 'refund':
                        if (typeof code != 'object') code = {};
                        swal({
                            title: code.title || "您确定要退款吗？",
                            text: code.text || "退款后将原路退回且无法恢复，请谨慎操作！",
                            type: code.type || "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#DD6B55",
                            confirmButtonText: code.confirm || "是的，我要退款！",
                            cancelButtonText: code.cancel || "让我再考虑一下…",
                            closeOnConfirm: false,
                            closeOnCancel: false
                        }).then(param).catch(console.log);
                ...
                new Vue({
                    ...
                    methods: {
                        ...
                        titleRoll: function (newTitle) {
                            var time = this.noticeTime, oldTitle = '迪远五金商城管理系统';
                        ...
                        getNotice: function () {
                            ...
                            if(url.indexOf('superadmin')!=-1){
                                var controller = 'superadmin';
                            }else{
                                var controller = 'admin';
                            }
                            $.ajax({
                                url: `/${controller}/index/Jnotice`,
                                type: 'get',
                                dataType: 'json',
