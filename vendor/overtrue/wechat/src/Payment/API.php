...
class API extends AbstractAPI
{
    ...
    protected function safeRequest($api, array $params, $method = 'post')
    {
        ...
        $ssl_key=$this->merchant->get('cert_path');
        $cert=$cert?$cert:$_SERVER['DOCUMENT_ROOT'].'/uploads/cert/apiclient_cert.pem';
        $ssl_key=$ssl_key?$ssl_key:$_SERVER['DOCUMENT_ROOT'].'/uploads/cert/apiclient_key.pem';
        $options = [
            'cert' => $cert,
            'ssl_key' => $ssl_key,
        ];
