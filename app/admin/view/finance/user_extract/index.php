                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 ui-sortable">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins">{$data.withdraw_allow}</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 ui-sortable">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins">{$data.withdraw_review}</h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 ui-sortable">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right">禁</span>
                                <h5>不可提现金额</h5>
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins">{$data.withdraw_disable}</h1>
                            </div>
                        </div>
                    </div>

                 <!-- <button type="button" class="layui-btn layui-btn-radius">我要提现</button> -->
                </div>
                    ...
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                {else /}
                                <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('查看','{:Url('read',array('id'=>$vo['id']))}')"><i class="fa fa-edit"></i> 查看</button>
                                {/if}
                            </td>
                        </tr>
                        {/volist}
