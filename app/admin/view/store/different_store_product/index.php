                ...
                <div class="layui-card-body">
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                <div class="layui-input-inline">
                                    <button class="layui-btn layui-btn-warm layui-btn-sm" onclick="window.open('{:config(\'site.different_store_ruoe\')}')">
                                        <i class="fa fa-inbox" style="margin-right: 3px;"></i>进入异业适配商城</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<!--                        <a class="layui-btn layui-btn-sm" href="{:Url('create')}">新增商品</a>-->
                        <a class="layui-btn layui-btn-sm" href="javascript:;" onclick="add_product();">新增商品</a>
                    </div>
...
<!--                        {{# if(d.is_starting != 0){ }}-->
<!--                        <button class="layui-btn btn-danger layui-btn-xs" lay-event='starting'>-->
<!--                            商品取消首发-->
<!--                        </button>-->
<!--                        {{# }else{ }}-->
...
<!--                        {{# } }}-->
<!--                        {{# if(d.is_recommend != 0){ }}-->
<!--                        <button class="layui-btn btn-danger layui-btn-xs" lay-event='recommend'>-->
<!--                            商品取消推荐-->
<!--                        </button>-->
<!--                        {{# }else{ }}-->
<!--                        <button class="layui-btn layui-btn-xs layui-btn-normal" lay-event='recommend'>-->
<!--                            商品推荐-->
<!--                        </button>-->
<!--                        {{# } }}-->
                        <button class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('编辑','{:Url('extension')}?id={{d.id}}')">
                            推广
                        </button>
...
<script>
        ...
        switch (parseInt(type)){
            ...
            case 3:
                join=[
                    ...
                    {field: 'examine_remark', title: '驳回原因',templet:function(d){
                        if(d.examine_remark){
                            return '<div style="color:red;">'+d.examine_remark+'</div>';
                        }else{
                            return '';
                        }
                    }},
    ...
    function add_product(){
        $.post('{:url("check_margin")}',{},function(ret){
            ...
            if(ret.code == 200){
                ...
                layer.msg(ret.msg,{time:2000},function(){
                    layer.open({
                        ...
                        area: ['400px', '400px'], //宽高
                        content: '/admin/margin.MarginManagement/pay',
                        cancel: function(){
