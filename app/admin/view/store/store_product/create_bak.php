                            ...
                            <div class="layui-tab-content">
                                <div class="layui-tab-item layui-show">
                                    <div class="layui-row layui-col-space15">
                                        ...
                                        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                            <div class="grid-demo grid-demo-bg1">
                                                <div class="layui-form-item">
                                                    ...
                                                    <div class="layui-input-block">
                                                        <input type="radio" name="spec_type" value="0" title="单规格" lay-filter="spec_type" :checked="formData.spec_type == 0 ? true : false">
                                                        <input type="radio" name="spec_type" value="1" title="多规格" lay-filter="spec_type" :checked="formData.spec_type == 1 ? true : false">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="layui-input-block">
                                                        <table class="layui-table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <input type="hidden" v-model="formData.attr.price" class="layui-input">
                                                                <input type="hidden" v-model="formData.attr.cost" class="layui-input">
                                                                <input type="hidden" v-model="formData.attr.ot_price" class="layui-input">
                                                                <input type="hidden" v-model="formData.attr.weight" class="layui-input">
                                                                <input type="hidden" v-model="formData.attr.volume" class="layui-input">
                                                                <!-- <input type="text" v-model="formData.attr.bar_code"
                                                                       class="layui-input"> -->
                                                            ...
                                                            <td><input type="text" v-model="formData.attr.volume"
                                                                       class="layui-input"></td> -->
                                                                <td>
                                                                    <input type="number" v-model="formData.attr.moq" class="layui-input" min=0>
                                                                </td>
                                                                <td>
                                                                    <input type="number" v-model="formData.attr.discount" class="layui-input" min=0>
                                                                </td>
                                                                <td>
                                                                    <input type="number" v-model="formData.attr.discount_gt" class="layui-input">
                                                                </td>
                                                                <td>
                                                                    <input type="number" v-model="formData.attr.discount_lt" class="layui-input">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                        ...
                                        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12" v-if="formData.spec_type == 1">
                                            ...
                                            <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                                    ...
                                                    <div class="layui-form-item rules">
                                                        ...
                                                        <div class="layui-input-block">
                                                            <div style="overflow: visible;text-overflow: inherit;white-space: normal;border-left: 0;">
                                                                <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" v-for="(val,inx) in item.detail">
                                                                    {{val}}
                                                                    <i class="layui-icon layui-icon-close" @click="deleteValue(item,inx)"></i>
                                                                </button>
                                                            </div>
                                                            <div class="rules rulesBox">
                                                                <div class="rules-btn-sm">
                                                                    <input type="text" v-model="item.detailValue" name="title" autocomplete="off" placeholder="请输入">
                                                                </div>
                                                                <button class="layui-btn layui-btn-sm" type="button" @click="addDetail(item)">添加
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="grid-demo grid-demo-bg1 rules" style="margin-top: 24px;" v-if="newRule">
                                                    <div class="layui-form-item layui-form-text rules">
                                                        ...
                                                        <div class="rules-btn-sm">
                                                            <input type="text" name="title" v-model="formDynamic.attrsName" autocomplete="off" placeholder="请输入规格">
                                                        </div>
                                                    </div>
                                                    <div class="layui-form-item layui-form-text rules">
                                                        <label class="layui-form-label">规格值：</label>
                                                        <div class="rules-btn-sm">
                                                            <input type="text" name="title" v-model="formDynamic.attrsVal" autocomplete="off" placeholder="请输入规格值">
                                                        </div>
                                                    </div>
                                                    <button class="layui-btn layui-btn-sm ml40" type="button" @click="createAttrName">添加
                                                    </button>
                                                    <button class="layui-btn layui-btn-sm ml10" type="button" @click="newRule = false">取消
                                                    </button>
                                                </div>
                                            ...
                                            <div class="layui-col-xs12 layui-col-sm12 layui-col-md12" v-if="formData.attrs.length && formHeader.length">
                                                            ...
                                                            <table class="layui-table">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <td style="text-align: center;">
                                                                        <button class="layui-btn layui-btn-sm" type="button" @click="batchAdd">批量修改
                                                                        </button>
                                                                        <button class="layui-btn layui-btn-sm layui-btn-danger" type="button" @click="batchClear">清空
                                                                        </button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <div class="layui-input-block">
                                                            <table class="layui-table">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        <button class="layui-btn layui-btn-sm" type="button" @click="deleteAttrs(index)">删除
                                                                        </button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                ...
                                <div class="layui-tab-item">
                                    <div class="layui-row layui-col-space15">
                                        ...
                                        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12" v-if="formData.is_sub == 1 && formData.spec_type == 1">
                                            <div class="grid-demo grid-demo-bg1">
                                                <div class="layui-form-item">
                                                    <label class="layui-form-label">批量设置</label>
                                                    <div class="layui-input-block">
                                                        <input style="width: 20%;display: inline-block;" type="number" name="brokerage" lay-verify="title" autocomplete="off" placeholder="请输入一级返佣" class="layui-input" v-model="brokerage.brokerage">
                                                        ...
                                                        <button class="layui-btn layui-btn-sm" style="height: 38px;" type="button" @click="addBrokerage">批量设置
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="layui-input-block">
                                                        <table class="layui-table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" v-model="formData.attr.brokerage" class="layui-input"></td>
                                        ...
                                        <!-- 单属性结束-->
                                        <!-- 多属性-->
                                        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12" v-if="formData.attrs.length && formHeader.length && formData.is_sub == 1 && formData.spec_type == 1">
                                            <div class="grid-demo grid-demo-bg1" style="margin-top: 20px">
                                                <div class="layui-form-item">
                                                    <label class="layui-form-label">商品属性：</label>
                                                    <div class="layui-input-block">
                                                        <table class="layui-table">
                                                            ...
                                                            <tr v-for="(item,index) in formData.attrs">
                                                                ...
                                                                <td>{{item.volume}}</td>
                                                                <td>
                                                                    <input type="number" v-model="item.brokerage" class="layui-input">
                                                                </td>
                                                                <!--                                                            <td>-->
                ...
                handleSubmit: function() {
                    ...
                    if (that.formData.spec_type == 0) {
                        ...
                        if (that.formData.attr.discount < 0) {
                            return that.showMsg('优惠量不能小于0');
                        }
                        if (that.formData.attr.discount_gt < 0) {
                            return that.showMsg('大于优惠量的售价不能小于0');
                        }
                        if (that.formData.attr.discount_lt < 0) {
                            return that.showMsg('小于优惠量的售价不能小于0');
                        }
                        ...
                        for (var index in that.formData.attrs) {
                            ...
                            if (that.formData.attrs[index].moq < 0) {
