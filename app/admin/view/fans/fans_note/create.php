        ...
        <div class="panel-body" style="padding: 30px">
            <form class="form-horizontal" id="signupForm">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <label style="color:#aaa">发布时间</label>
                            <br/>
                            <input type="radio" name="is_add_time" class="layui-radio" value="1" {eq name="news['is_add_time']" value="1"}checked{/eq}>显示
                            <input type="radio" name="is_add_time" class="layui-radio" value="0" {eq name="news['is_add_time']" value="0"}checked{/eq}>隐藏
                        </div>
                        <div class="col-md-6">
                            <label style="color:#aaa">阅读数</label>
                            <br/>
                ...
                <div>
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <label style="color:#aaa">点赞数</label>
                            <br/>
                            <input type="radio" name="is_dianzan" class="layui-radio" value="1" {eq name="news['is_dianzan']" value="1"}checked{/eq}>显示
                            <input type="radio" name="is_dianzan" class="layui-radio" value="0" {eq name="news['is_dianzan']" value="0"}checked{/eq}>隐藏
                        </div>
                        <div class="col-md-6">
                            <label style="color:#aaa">进入店铺</label>
                            <br/>
                            <input type="radio" name="is_into_shop" class="layui-radio" value="1" {eq name="news['is_into_shop']" value="1"}checked{/eq}>显示
                            <input type="radio" name="is_into_shop" class="layui-radio" value="0" {eq name="news['is_into_shop']" value="0"}checked{/eq}>隐藏
                        </div>
                    </div>
                </div>
...
//        console.log(goodsIdArr.toString());
        ...
        list.is_dianzan = $("input[name='is_dianzan']:checked").val();
