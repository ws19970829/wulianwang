                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element admin_open">
                            <span>
                                <img alt="image" class="imgbox" src="{$site_logo}" onerror="javascript:this.src='/static/img/head.jpg';" />
                            </span>
            ...
            <div class="row content-tabs" @touchmove.prevent>
                ...
                <ul class="dropdown-menu dropdown-alerts dropdown-menu-right">
                    ...
                    <li>
                        <a class="J_menuItem" href="{:Url('order.store_order/index')}">
                            <div>
                                <i class="fa fa-comments-o"></i> 退款 <span class="pull-right text-muted small" id="refund">0个</span>
                            </div>
                        </a>
                    </li>
                    <li class="divider"></li>
...
<!-- 
            ...
            <div class="footer" @touchmove.prevent>
                <div class="pull-right">© 2017-{:date('Y')} <a href="javascript:;" target="_blank">多麦五金商城</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
