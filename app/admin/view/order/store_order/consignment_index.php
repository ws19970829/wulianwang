                ...
                <div class="layui-card-body">
                  ...
                  <!--赠品信息-->
                    ...
                    <script type="text/html" id="act">
                        {{# if(d.org_tenant_id != d.cur_tenant_id){ }}
                            <button button class="btn btn-primary btn-xs" type="button" href="javascript:void(0);" lay-event='order_info'>
...
{block name="script"}
<script>
    layList.tableList('List', "{:Url('consignment_order_index',['real_name'=>$real_name])}", function () {
        return [
            {type: 'checkbox'},
            ...
            {field: 'gift_list', title: '支付有礼', templet: "#gift_list", height: 'full-20'},
            ...
            {field: 'mark', title: '用户备注', width: '10%', sort: true, align: 'center'},
        ...
        new Vue({
            ...
            data: {
                ...
                orderType: [
                    ...
                    {name: '限时折扣', value: 2, count: orderCount.discount},
                    {name: '限时秒杀', value: 3, count: orderCount.seckill},
                    {name: '支付有礼', value: 4, count: orderCount.gift},
                ],
                //原筛选备份
//                orderType: [
//                    {name: '全部', value: ''},
...
//                ],
            ...
            methods: {
                ...
                excel: function () {
                    this.where.excel = 1;
                    location.href = layList.U({c: 'order.store_order', a: 'consignment_order_index', q: this.where});
                    this.where.excel = 0;
                },
