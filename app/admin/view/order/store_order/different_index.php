...
{block name="script"}
<script>
    layList.tableList('List', "{:Url('different_order_index',['real_name'=>$real_name])}", function () {
        return [
            {type: 'checkbox'},
...
//                ],
            ...
            methods: {
                ...
                excel: function () {
                    this.where.excel = 1;
                    location.href = layList.U({c: 'order.store_order', a: 'different_order_index', q: this.where});
                    this.where.excel = 0;
                },
