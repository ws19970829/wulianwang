                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" class="layui-input" placeholder="请输入标签名称">
                                </div>
                            </div>
                            <div class="layui-inline">
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="layui-btn-container">
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}',{w:1000})">添加会员标签</button>
                    </div>
                    ...
                    <script type="text/html" id="act">
                        ...
                        <button class="layui-btn btn-danger layui-btn-xs" lay-event='delete'>
...
<script>
    ...
    layList.tableList('List',"{:Url('get_list')}",function (){
        return [
            ...
            {field: 'title', title: '标签名称',edit:'name',align:"center"},
            {field: 'is_auto', title: '标签类型',edit:'grade',align:"center"
                ,templet:function (d) {
                    return d.is_auto?'自动标签':'手动标签';
                }
            },
    ...
    layList.switch('status',function (odj,value) {
        if(odj.elem.checked==true){
            layList.baseGet(layList.Url({c:'user.user_tag',a:'set_status',p:{status:1,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }else{
            layList.baseGet(layList.Url({c:'user.user_tag',a:'set_status',p:{status:0,id:value}}),function (res) {
                layList.msg(res.msg);
            });
        }
    });
