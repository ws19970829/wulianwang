...
<!--                        </div>-->
                        ...
                        <!-- <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <select name="tags" lay-verify="tags">
                                    <option value="">全部</option>
                                    {foreach $tags as $vo}
...
<!--                        </div>-->
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" name="price_num_min" placeholder="/次" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">-</label>
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" name="price_num_max" placeholder="/次" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
...
<!--                        </div>-->
<!--                        <div class="layui-inline">-->
<!--                            <label class="layui-form-label">成为用户时间：</label>-->
<!--                            <div class="layui-input-inline">-->
<!--                                <input type="text" class="layui-input time-w" name="change_user_time" lay-verify="change_user_time"  id="change_user_time" placeholder=" - ">-->
<!--                            </div>-->
<!--                        </div>-->
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" name="price_min" placeholder="/元" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">-</label>
                        ...
                        <!-- <div class="layui-inline">
                            ...
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" name="unit_price_min" placeholder="/元" autocomplete="off" class="layui-input">
                            </div>
                        </div> -->
                        <!-- <div class="layui-inline">
                            <label class="layui-form-label">-</label>
                            <div class="layui-input-inline" style="width: 100px;">
                                <input type="text" name="unit_price_max" placeholder="/元" autocomplete="off" class="layui-input">
                            </div>
                        </div> -->
...
<!--                        <button class="layui-btn layui-btn-sm layui-btn-normal" type="button" data-type="set_status_j"><i class="fa fa-check-circle-o"></i>解封</button>-->
                        ...
                        <button class="layui-btn layui-btn-sm layui-btn-normal" type="button" data-type="add_tags"><i class="fa fa-check-circle-o"></i>加标签</button> -->
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0);" lay-event="money">
                                    <i class="layui-icon layui-icon-edit"></i> 修改余额</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" lay-event="edit_tag">
                                    <i class="layui-icon layui-icon-edit"></i> 管理标签</a>
                            </li>
<!--                            <li>-->
...
//            {field: 'user_type', title: '用户类型',width:'6%',align:'center'},
            {field: 'operate', title: '操作', width: '14%', align: 'center', toolbar: '#barDemo'}
        ];
    });
    //页面刷新时加载
    ...
    layList.tool(function (event,data,obj) {
        ...
        switch (layEvent){
            ...
            case 'money':
                ...
                break;
            case 'edit_tag':
                $eb.createModalFrame(data.nickname+'-管理标签',layList.Url({a:'user_tags_list',p:{uid:data.uid}}));
                break;
            case 'open_image':
...
//        if(where['user_time_type'] == '' && where['user_time'] != '') return layList.msg('请选择访问情况');
    ...
    var action={
        ...
        add_tags:function () {
            ...
            if(ids.length){
                var str = ids.join(',');
                $eb.createModalFrame('添加标签',layList.Url({c:'user.user',a:'grant_tags',p:{id:str}}),{'w':800});
            }else{
                layList.msg('请选择要加标签的会员');
            }
        },
