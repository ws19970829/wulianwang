...
<!--                            <input onclick="set_type(2)" type="radio" name="limit_buy_type" id="limit_buy_type2" class="layui-radio" value="2" {eq name="news['limit_buy_type']" value="2"}checked{/eq}><label for="limit_buy_type2">&nbsp;&nbsp;前几件享受秒杀</label>-->
                        </div>
                ...
                <div class="layui-inline dis_type2 {if $news.limit_buy_type!=2}hide{/if}">
                    <label class="layui-form-label">每人每种商品前几件享受秒杀</label>
                    <div class="layui-input-inline" style="width: 200px;">
