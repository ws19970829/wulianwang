        ...
        <div class="ibox float-e-margins">
            ...
            <div class="tabs-container ibox-title  gray-bg">
                <ul class="nav nav-tabs">
                    ...
                    <li {if $gid==$vo.id}class="active"{/if}><a href="{:url('setting.system_group_data/index')}?gid={$vo.id}"><i class=""></i>{$vo.name}</a></li>
                    {/foreach}
                </ul>
                        ...
                        <div class="col-sm-8 m-b-xs">
                          ...
                          <div class="input-group">
                            ...
                            <form action="" class="form-inline">
                                <i class="fa fa-search" style="margin-right: 10px;"></i>
                                <input type="hidden" name="gid" value="{$where.gid}">
                        ...
                        <table class="table table-striped  table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <img class="image" data-image="{$valueItem}" width="45" height="45" src="{$valueItem}" />
                                    {/volist}
                                    {else/}
                                    <img class="image" data-image="{$vo.value[$item['title']]['value']}" width="45" height="45" src="{$vo.value[$item['title']]['value']}" />
                                    {/if}
                                    {else/}
                                ...
                                <td class="text-center">
                                    <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑','{:Url('edit',array('gid'=>$gid,'id'=>$vo['id']))}')"><i class="fa fa-edit"></i> 编辑</button>
