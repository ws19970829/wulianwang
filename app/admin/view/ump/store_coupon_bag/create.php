    ...
    <div class="col-sm-12 panel panel-default" >
        <div class="panel-body" style="padding: 30px">
            <form class="form-horizontal" id="signupForm">
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="input-group">
                            <span class="input-group-addon">礼包名称</span>
                ...
                <table class="layui-table dis_coupon>
                    <colgroup>
                        <col width="150">
                        <col width="200">
                        <col>
                    ...
                    {else}
                    <tr>
                        <td class="please_select" colspan="6">
                            请选择优惠券
                        </td>
                    </tr>
                    {/if}
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <label class="layui-form-label">礼包发放上限</label>
                            <div class="layui-input-block">
                                <input style="width: 40%" id="total_count" type="text" value="1" name="total_count" autocomplete="off" placeholder="请输入领取上限" class="layui-input" >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <label style="color:#aaa">礼包失效条件</label>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <input onclick="set_type(1)" type="radio" name="type" id="type1" class="layui-radio" value="1" {eq name="news['type']" value="1"}checked{/eq}><label for="type1">&nbsp;&nbsp;任意优惠券库存不足或失效时</label>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input onclick="set_type(2)" type="radio" name="type" id="type2" class="layui-radio" value="2" {eq name="news['type']" value="2"}checked{/eq}><label for="type2">&nbsp;&nbsp;所有优惠券库存不足或失效时</label>&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <label style="color:#aaa">是否公开领取</label>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="is_public" id="is_public0" class="layui-radio" value="0" {eq name="news['is_public']" value="0"}checked{/eq}><label for="is_public0">&nbsp;&nbsp;否</label>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="is_public" id="is_public1" class="layui-radio" value="1" {eq name="news['is_public']" value="1"}checked{/eq}><label for="is_public1">&nbsp;&nbsp;是</label>&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
...
//        console.log(goodsIdArr.toString());
        ...
        list.id = $('#id').val();/* 原文链接 */
        list.total_count = $('#total_count').val();/* 原文链接 */
        list.type = $("input[name='type']:checked").val();
        list.is_public = $("input[name='is_public']:checked").val();
