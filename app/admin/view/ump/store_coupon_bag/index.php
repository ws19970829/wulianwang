    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}?type=0')">添加礼包</button>
                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline">
                            ...
                            <select name="type" aria-controls="editable" class="form-control input-sm">
                                ...
                                <option value="0" {eq name="where.type" value="0"}selected="selected"{/eq}>平台券</option>
                ...
                <div class="table-responsive" style="overflow:visible">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <th class="text-center">领取上限</th>
                            <th class="text-center">剩余领取次数</th>
                            <th class="text-center">是否公开领取</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span style="color: #2973e0;cursor: pointer" onclick="$eb.createModalFrame(this.innerText,'{:Url('view_issue')}?coupon_bag_id={$vo.id}',{w:1100,h:760})">
                                     {$vo.coupon_issue_count}
                                </span>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                ...
                                <div class="input-group-btn js-group-btn">
                                    ...
                                    <button style="margin-right: 10px;" class="layui-btn layui-btn-xs" onclick="$eb.createModalFrame('推广(点击图片可下载)','{:Url('extension')}?id={$vo.id}',{w:500,h:700})">
                                        领取地址
                                    </button>
