    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}?type=1')">添加优惠券</button>
                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline">
                            ...
                            <select name="type" aria-controls="editable" class="form-control input-sm">
                                ...
                                <option value="1" {eq name="where.type" value="1"}selected="selected"{/eq}>商家券</option>
                                ...
                                <div class="input-group-btn js-group-btn">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <!-- <li>
                                                <a href="javascript:void(0);" onclick="$eb.createModalFrame(this.innerText+' [{$vo.title}] 优惠劵','{:Url('issue_bag',['id'=>$vo['id']])}')">
                                                    <i class="fa  fa-male"></i> 发布礼包优惠券
                                                </a>
                                            </li> -->
                                            {/if}
                                            <li>
