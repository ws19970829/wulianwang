            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="time">
                     <p>日期:{{d.start_day}}-{{d.stop_day}}</p>
                     <p>时间:{{d.start_time}}-{{d.stop_time}}</p>
                     <p class="layui-badge layui-bg-green">{{d.status_text}}</p>
                    </script>
...
<script>
    ...
    layList.tableList('seckillList',"{:Url('get_seckill_list')}",function () {
        return [
            ...
            {field: 'image', title: '商品图片', templet: '<p><img src="{{d.image}}" alt="{{d.title}}" class="open_image" data-image="{{d.image}}"></p>'},
            {field: 'title', title: '商品名称'},
            // {field: 'info', title: '活动简介',width:'20%'},
            // {field: 'ot_price', title: '原价',width:'6%'},
            {field: 'price', title: '活动价',width:'6%'},
            // {field: 'num', title: '秒杀数量购买限制',width:'8%'},
            {field: 'quota', title: '限量剩余',width:'8%'},
            {field: 'status', title: '秒杀时间',width:'18%',toolbar:"#time"},
