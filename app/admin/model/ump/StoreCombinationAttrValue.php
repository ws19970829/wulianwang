...
class StoreCombinationAttrValue extends BaseModel
{
    /**
     * 模型名称
     * @var string
     */
    protected $name = 'store_combination_attr_value';
    ...
    public static function clearProductAttrValue($productId,$activity_id)
    {
