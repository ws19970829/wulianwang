...
class ShippingTemplates extends AuthController
{
    ...
    public function save($id = 0)
    {
        ...
        try {
            if ($id) {
                ...
                $temp['tenant_id']=session('tenant_id');
    ...
    {
        return JsonService::successful(STModel::order('sort desc,id desc')->where('tenant_id','=',session('tenant_id'))->field(['id', 'name'])->select()->toArray());
    }
