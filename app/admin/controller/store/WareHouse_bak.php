...
class WareHouse extends AuthController
{
    ...
    public function is_format_attr($id = 0, $type = 0)
    {
        ...
        // $header[] = ['title' => '图片', 'slot' => 'pic', 'align' => 'center', 'width' => 120];
        ...
        // $header[] = ['title' => '优惠数量', 'slot' => 'discount', 'align' => 'center', 'minWidth' => 140];
        // $header[] = ['title' => '大于等于优惠数量的售价', 'slot' => 'discount_gt', 'align' => 'center', 'minWidth' => 140];
        // $header[] = ['title' => '小于等于优惠数量的售价', 'slot' => 'discount_lt', 'align' => 'center', 'minWidth' => 140];
    ...
    public function record(Request $request)
    {
        ...
        $suk = $param['suk'];
        $unique = StoreProductAttrValue::getunique($product_id, $suk, 0, 0);

        $this->assign(compact('product_id', 'unique'));
        return view();
    }
    ...
    public function record_ist()
    {
        ...
        return Json::successlayui(StoreWarehouse::record($where));
    }

    /**无货预售 */
    public function pre_sale(Request $request)
    {
        $param = $request->param();
        $product_id = $param['product_id'];
        ...
        if ($request->isGet()) {
            ...
            $suk = $param['suk'];
            $data = StoreProductAttrValue::where([
            ...
            try {
                $update = [
                    'advance_time' => $param['advance_time'],
                    // 'advance_day' => $param['advance_day'],
                    'advance_sale' => $param['advance_sale']
                ];
