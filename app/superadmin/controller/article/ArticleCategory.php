...
use app\superadmin\model\article\{ArticleCategory as ArticleCategoryModel,Article as ArticleModel};
...
class ArticleCategory extends AuthController
{
    ...
    public function create()
    {
        ...
        $f[] = Form::frameImageOne('image', '分类图片', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'image')))->icon('image')->width('100%')->height('500px');
    ...
    public function edit($id)
    {
        ...
        $f[] = Form::frameImageOne('image', '分类图片', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'image')), $article['image'])->icon('image')->width('100%')->height('500px');
