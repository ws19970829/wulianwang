...
namespace app\superadmin\controller\user;
 ...
 * 产品数据分析管理
 * Class StoreProduct
 * @package app\supersuperadmin\controller\store
 */
class UserProductLog extends AuthController
{
    ...
    public function index()
    {
        ...
        $this->assign([
            ...
            'orderCount' => StoreOrder::orderCount(),
            'payTypeCount' => StoreOrder::payTypeCount(),
        ]);
    ...
    public function product_ist()
    {
        ...
        return Json::successlayui(ProductModel::ProductListToProductLog($where));
    }
...
//        $result = StoreProductAttrResult::getResult($id);
     ...
     */
    public function extension_bak($id)
    {
        ...
        $url = $site_name.'/'.'superadmin/'.$system_admin_id.'/product_id/'.$id;
     ...
     */
    function extension($config=array(), $filename="")
    {
