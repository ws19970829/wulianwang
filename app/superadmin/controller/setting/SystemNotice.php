...
use app\superadmin\model\system\{SystemAdmin, SystemNotice as NoticeModel};
...
class SystemNotice extends AuthController
{
    ...
    public function create()
    {
        ...
        $f[] = Form::frameInputOne('icon', '图标', Url::buildUrl('superadmin/widget.widgets/icon', array('fodder' => 'icon')))->icon('ionic')->height('500px');
    ...
    public function edit($id)
    {
        ...
        $f[] = Form::frameInputOne('icon', '图标', Url::buildUrl('superadmin/widget.widgets/icon', array('fodder' => 'icon')), $data->icon)->icon('ionic')->height('500px');
