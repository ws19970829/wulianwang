...
use app\superadmin\model\system\SystemMenus as MenusModel;
...
//            ['access',''],
    ...
    public function create($cid = 0)
    {
        ...
        $field[] = Form::select('module', '模块名')->options([
            ['label' => '商家后台', 'value' => 'admin'],
            ['label' => '超级管理员后台', 'value' => 'superadmin'],
            ]
        );
        ...
        $field[] = Form::frameInputOne('icon', '图标', Url::buildUrl('superadmin/widget.widgets/icon', array('fodder' => 'icon')))->icon('ionic')->height('500px');
    ...
    public function edit($id)
    {
        ...
        $field[] = Form::select('module', '模块名', $menu['module'])->options([
        ...
        $field[] = Form::frameInputOne('icon', '图标', Url::buildUrl('superadmin/widget.widgets/icon', array('fodder' => 'icon')), $menu['icon'])->icon('ionic')->height('500px');
