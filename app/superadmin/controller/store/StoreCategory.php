...
use app\superadmin\model\system\SystemAttachment;
...
class StoreCategory extends AuthController
{
    ...
    public function create()
    {
        $field = [
            ...
            Form::frameImageOne('pic', '分类图标(180*180)', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'pic')))->icon('image')->width('100%')->height('500px'),
            Form::number('sort', '排序'),
            Form::radio('is_show', '状态', 1)->options([['label' => '显示', 'value' => 1], ['label' => '隐藏', 'value' => 0]]),
            Form::radio('is_top', '是否推荐', 0)->options([['label' => '是', 'value' => 1], ['label' => '否', 'value' => 0]])
        ];
    ...
    public function save(Request $request)
    {
        ...
        if ($data['pid'] == 0) {
            ...
            $data['level'] = CategoryModel::where('id', $data['pid'])->value('level') + 1;
        }
    ...
    public function edit($id)
    {
        ...
        $field = [
            ...
            Form::frameImageOne('pic', '分类图标', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'pic')), $c->getData('pic'))->icon('image')->width('100%')->height('500px'),
            Form::number('sort', '排序', $c->getData('sort')),
            Form::radio('is_show', '状态', $c->getData('is_show'))->options([['label' => '显示', 'value' => 1], ['label' => '隐藏', 'value' => 0]]),
            Form::radio('is_top', '是否推荐', $c->getData('is_top'))->options([['label' => '是', 'value' => 1], ['label' => '否', 'value' => 0]])
        ];
