...
use app\superadmin\model\wechat\WechatNews as WechatNewsModel;
use app\superadmin\model\article\ArticleCategory as ArticleCategoryModel;
...
class StoreInfoMana extends AuthController
{
    ...
    public function create()
    {
        ...
        FormBuilder::frameImageOne('image', '分类图片', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'image')))->icon('image')->width('100%')->height('500px');
