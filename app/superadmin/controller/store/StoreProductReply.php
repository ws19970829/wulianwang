...
use app\superadmin\model\store\StoreProductReply as ProductReplyModel;
use crmeb\services\{
...
class StoreProductReply extends AuthController
{
    ...
    public function create()
    {
        $field = [
            ...
            Form::frameImageOne('avatar', '用户头像', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'avatar')))->icon('image')->width('100%')->height('500px'),
            Form::frameImages('pics', '评价图片', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'pics')))->maxLength(5)->icon('images')->width('100%')->height('500px')->spin(0)
        ];
