...
use app\superadmin\model\wechat\{
...
class StoreService extends AuthController
{
    ...
    public function edit($id)
    {
        ...
        $f = array();
        $f[] = Form::frameImageOne('avatar', '客服头像', Url::buildUrl('superadmin/widget.images/index', array('fodder' => 'avatar')), $service['avatar'])->icon('image')->width('100%')->height('500px');
