...
<!-- <button type="button" class="layui-btn layui-btn-xs" style="margin-bottom: 5px" onclick=" window.print();">打印订单</button> -->
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        ...
                        <div class="col-xs-12">物流信息: {$orderInfo.express_name}</div>
                        <div class="col-xs-12">物流单号: {$orderInfo.delivery_id|default='无'}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        ...
                        <div class="col-xs-6">订单类型: {$orderInfo.order_type_text}</div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        ...
                        <div class="col-xs-6">快递单号: {//$orderInfo.delivery_id} </button> -->
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        {foreach $cartinfo as $vo}
                        <div class="col-xs-12" >
                            {$vo.productInfo.store_name}/{$vo.productInfo.attrInfo.suk}&nbsp;&nbsp;&nbsp;{$vo.cart_num}*￥{$vo.unit_price}
                        </div>
                        {/foreach}
                    </div>
                </div>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        <div class="col-xs-6" >{if $orderInfo.remark}{$orderInfo.remark}{else}暂无备注信息{/if}</div>
                    </div>
                </div>
            </div>
        </div>
