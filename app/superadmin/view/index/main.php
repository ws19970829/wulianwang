...
<div class="row">
    ...
    <!--                    <small><a href="javascript:;" class="opFrames" data-name="提现申请" data-href="{:Url('finance.user_extract/index')}">待提现</a></small>-->
    <!--                </div>-->
    <!--            </div>-->
    <!--        </div>-->
    <div class="col-sm-3 ui-sortable">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{$first_line.today_num.data}</h1>
                ...
                <!--                    </div>-->
                <small><a href="javascript:;" class="opFrames" data-name="订单管理" data-href="{:Url('order.store_order/index')}?data=yesterday">今日支付订单数</a></small>
            </div>
        </div>
    </div>
    <div class="col-sm-3 ui-sortable">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{$first_line.today_price.data}</h1>
                ...
                <!--                    </div>-->
                <small><a href="javascript:;" class="opFrames" data-name="订单管理" data-href="{:Url('order.store_order/index')}?data=yesterday">今日交易额</a></small>
            </div>
        </div>
    </div>
    <div class="col-sm-3 ui-sortable">
