...
<script>
    ...
    layList.tableList('List',"{:Url('product_ist')}?type={$type}",function (){
        return [
            ...
            {field: 'view_num', title: '曝光次数',width:'8%'},
            {field: 'visit_num', title: '访问次数',width:'8%'},
            {field: 'view_user_num', title: '曝光人数(UV)',width:'8%'},
            {field: 'visit_ip_num', title: '访客数(IP)',width:'8%'},
            {field: 'visit_user_num', title: '浏览量(PV)',width:'8%'},
            {field: 'cart_user_num', title: '加购人数',width:'8%'},
            {field: 'cart_num', title: '加购件数',width:'8%'},
            {field: 'pay_user_num', title: '支付人数',width:'8%'},
            {field: 'pay_rate', title: '单品转换率',width:'8%'},
    ...
    layList.search('export',function(where){
        where.excel = 1;
        location.href=layList.U({a:'product_ist',q:where});
    })
    //下拉框
