...
<script>
    ...
    layList.form.render();
    //加载列表
    layList.tableList('List',"{:Url('product_ist',['type'=>$type,'shop_id'=>$shop_id])}",function (){
        return [
                    {type:'checkbox'},
                    ...
                    {field: 'is_hot', title: '推荐状态',width:'13%',templet:function(d){
                        if(d.is_hot==1){
                    ...
                    {field: 'ficti', title: '虚拟销量',sort: true,edit:'ficti',width:'6%'},
