                            ...
                            <div class="layui-tab-item layui-show">
                                <div class="layui-row layui-col-space15">
                                    ...
                                    <div class="layui-col-xs2 layui-col-sm2 layui-col-md2">
                                        <div class="grid-demo grid-demo-bg1">
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">起订量<i class="red">*</i></label>
                                                <div class="layui-input-block">
                                                    <input type="number" name="moq" lay-verify="number" autocomplete="off"
                                                           placeholder="请输入起订量" class="layui-input" v-model="formData.moq" min='0'>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <table class="layui-table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" v-model="formData.attr.volume"
                                                                       class="layui-input"></td>
                                                            <td><input type="number" v-model="formData.attr.discount"
                                                                       class="layui-input"></td>
                                                            <td><input type="number" v-model="formData.attr.discount_gt"
                                                                       class="layui-input"></td>
                                                            <td><input type="number" v-model="formData.attr.discount_lt"
                                                                       class="layui-input"></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                    ...
                                                    <div class="layui-input-block">
                                                        <table class="layui-table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number" v-model="batchAttr.discount"
                                                                           class="layui-input" min=0>
                                                                </td>
                                                                <td>
                                                                    <input type="number" v-model="batchAttr.discount_gt"
                                                                           class="layui-input">
                                                                </td>
                                                                <td>
                                                                    <input type="number" v-model="batchAttr.discount_lt"
                                                                           class="layui-input">
                                                                </td>
    ...
    new Vue({
        ...
        methods: {
            ...
            getProductInfo: function () {
                var that = this;
                var url = "{:url('store.StoreProduct/get_product_info')}?id="+that.id;
            ...
            generate: function (type = 0) {
                ...
                $.ajax({
                    type: "post",
                    url: "{:url('is_format_attr')}",
                    data: {
                        id:that.id,
                        type,
                        attrs:that.formData.attrs
                    },
                    dataType: "json",
            ...
            getRuleList:function (type) {
                var that = this;
                var url = "{:url('store.StoreProduct/get_rule')}";
                that.requestGet(url).then(function (res) {
            ...
            addRule:function(){
                var url = "{:url('store.StoreProductRule/create')}";
