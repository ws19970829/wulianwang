            ...
            <form id="form_data" class="layui-form" method="post" action="{:url('save')}">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入驳回原因" class="layui-textarea" name="examine_remark" id="examine_remark"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    function save(){
        ...
        $.post("{:url('is_no_starting')}",{id:id,examine_remark:examine_remark},function(ret){
