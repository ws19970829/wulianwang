                                ...
                                <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                    <div class="grid-demo grid-demo-bg1">
                                        <div class="layui-form-item" v-if="id">
                                            <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" @click="goBack">返回列表</button>
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            goBack:function(){
                location.href = this.U({m:'superadmin',c:'store.DifferentStoreProductExamine',a:'index'});
            },
            U: function (opt) {
    ...
    addRule:function(){
        return this.createFrame('添加商品规则',this.U({c:'store.DifferentStoreProduct',a:'create'}));
    },
    allRule:function () {
        if (this.ruleIndex != -1) {
