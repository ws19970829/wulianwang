...
<script>
    layList.form.render();
    layList.tableList('combinationList',"{:Url('get_combination_list')}?tenant_id={$tenant_id}",function () {
        return [
            {type:'checkbox'},
            ...
            {field: 'goods_num', title: '成团量',width:'7%'},
            {field: 'sales', title: '销量',width:'7%'},
            {field: 'quota', title: '限量剩余',width:'6%'},
            {field: '_stop_time', title: '结束时间', width:'8%',toolbar: '#stopTime'},
            {field: 'is_host', title: '推荐状态',width:'15%',templet:function(d){
                        if(d.is_host==1){
