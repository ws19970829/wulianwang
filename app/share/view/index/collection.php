...
<body>
    <div class="cont">
        ...
        <div class="contList">
            <div class="contListLeft">付款码名称：</div>
            <div class="contListRight">{$info.title}</div>
        </div>
        {if $info.type==0}
        <div class="contList">
            <div class="contListLeft">付款金额：</div>
            <input class="contListInput" id="money" type="number" value="" placeholder="请输入收款金额">
        </div>
        {/if}

    </div>
    <div class="bt" onclick="submit_pay()">
        去支付
    </div>
        ...
        WeixinJSBridge.invoke(
            ...
            function(res){
                if(res.err_msg == "get_brand_wcpay_request:ok"){
                    window.location.href='/share/index/pay_success';
