...
class AllowOriginMiddleware implements MiddlewareInterface
{
    ...
    protected $header = [
        ...
        'Access-Control-Allow-Headers' => 'tenant_id,Authori-zation,Authorization, Content-Type, If-Match, If-Modified-Since, If-None-Match, If-Unmodified-Since, X-Requested-With',
